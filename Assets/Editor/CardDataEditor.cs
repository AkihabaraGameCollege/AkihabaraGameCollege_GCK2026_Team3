...
public class CardDataEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        card.cardDetail_Image   = (Sprite)EditorGUILayout.ObjectField("詳細画像", card.cardDetail_Image, typeof(Sprite), false);
            ...
            case CardType.Attack:
                ...
                switch (card.effectType)
                {
                    ...
                    case CardEffectType.DamageSingleAreaStop:
                        attack.areaRadius = EditorGUILayout.FloatField("半径", attack.areaRadius);
                        attack.stopDuration = EditorGUILayout.FloatField("停止時間", attack.stopDuration);
                        break;
                }
                break;
